...
export class App implements OnInit {
  ...
  isAdmin() {
    const isUserAdmin = this.authService.isLogged() && this.authService.admin;
    // console.log("isAdmin check:", isUserAdmin, "Logged:", this.authService.isLogged(), "Admin:", this.authService.admin);
    return isUserAdmin;
  }
